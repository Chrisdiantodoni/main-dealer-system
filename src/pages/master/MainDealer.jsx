...
const MainDealer = () => {
  ...
  const { data, isFetching, refetch, isSuccess, isRefetching } = useQuery({
    queryKey: ["getMainDealerList", resultQueryString],
    queryFn: async () => {
      const response = await master.getMainDealerList(resultQueryString);
      return response;
    },
  });
  useEffect(() => {
...
const headers = [
  ...
  {
    title: "Area",
    key: "main_dealer_area",
  },
  {
    title: "Code",
    key: "main_dealer_code",
  },
  {
    title: "Identifier",
    key: "main_dealer_identifier",
  },
];
