...
import ModalMasterDistrict from "@/components/Modal/Master/ModalMasterDistrict";
...
const District = () => {
  ...
  const { data, isFetching, refetch, isSuccess, isRefetching } = useQuery({
    queryKey: ["getDistrict", resultQueryString],
    queryFn: async () => {
            ...
            <div className="grid grid-cols-2 lg:grid-cols-12 gap-5 ">
              <div className="col-span-2">
                <Button
                  ...
                  onClick={() => handleModal("modalMasterDistrict", true)}
                />
              </div>
            </div>
          </div>
              ...
              data={data?.data?.data.map((item, index) => ({
                ...
                action: (
                  <Button
                    ...
                    onClick={() =>
                      handleModal("modalMasterDistrict", true, item)
                    }
                  />
                ),
              }))}
