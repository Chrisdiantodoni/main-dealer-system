...
export const menuItems = [
  ...
  {
    title: "Unit",
    icon: "material-symbols:motorcycle",
    link: "#",
    isHide: false,
    child: [
      {
        childtitle: "Shipping Order",
        childlink: "shipping-order",
      },
      {
        childtitle: "Unit",
        childlink: "unit-order",
      },
      {
        childtitle: "Unit Return",
        childlink: "unit-return",
      },
    ],
  },
  {
  ...
  {
    title: "Faktur Receive",
    icon: "mdi:invoice-receive",
    link: "biro/faktur-receive",
    isHide: false,
    permission: [
      {
        permission: "event",
  ...
  },
  {
    ...
    child: [
      {
        childtitle: "Main Dealer",
        childlink: "master-data/main-dealer",
      },
      {
        childtitle: "Dealer",
        childlink: "master-data/dealer",
      },
      {
        childtitle: "Dealer NEQ",
        childlink: "master-data/dealer-neq",
      },

      // {
      //   childtitle: "Surveyor",
      //   childlink: "master-data/surveyor",
      // },
      {
        childtitle: "Pooling Source",
        childlink: "master-data/pooling-source",
      },
      {
        childtitle: "Province",
        childlink: "master-data/province",
      },
      {
        childtitle: "City",
        childlink: "master-data/city",
      },
      {
        childtitle: "District",
        childlink: "master-data/district",
      },
      {
        childtitle: "Sub District",
        childlink: "master-data/sub-district",
      },
      {
        childtitle: "Marital",
        childlink: "master-data/marital",
      },
      {
        childtitle: "Hobbies",
        childlink: "master-data/hobbies",
      },
      {
        childtitle: "Residence",
        childlink: "master-data/residence",
      },
      {
        childtitle: "Motor Brand",
        childlink: "master-data/motor-brand",
      },
      {
        childtitle: "Motor Variant",
        childlink: "master-data/motor-variant",
      },
      {
        childtitle: "Education",
        childlink: "master-data/education",
      },
      {
        childtitle: "Occupation",
        childlink: "master-data/occupation",
      },
      // {
      //   childtitle: "Motor",
      //   childlink: "master-data/motor",
      // },
      // {
      //   childtitle: "Color",
      //   childlink: "master-data/color",
      // },

      {
        childtitle: "Salesman",
        childlink: "master-data/salesman",
      },
      {
        childtitle: "Microfinance",
        childlink: "master-data/microfinance",
      },
      {
        childtitle: "Leasing",
        childlink: "master-data/leasing",
      },
      {
        childtitle: "Income",
        childlink: "master-data/income",
      },
      {
        childtitle: "Expenditure",
        childlink: "master-data/expenditure",
      },

      {
        childtitle: "Tenor",
        childlink: "master-data/tenor",
      },
      {
        childtitle: "Biro",
        childlink: "master-data/biro",
      },
      {
        childtitle: "API KEY",
        childlink: "master-data/api-key",
      },
    ],
  },

  {
    ...
    child: [
      // {
      //   childtitle: "User Dealer",
      //   childlink: "master-data/user-dealer",
      // },
      {
        childtitle: "User",
        childlink: "master-data/user",
      },
    ],
  },
  {
    ...
    child: [
      ...
      {
        childtitle: "SPK",
        childlink: "database-fixer/spk-digital",
      },
    ],
  },
